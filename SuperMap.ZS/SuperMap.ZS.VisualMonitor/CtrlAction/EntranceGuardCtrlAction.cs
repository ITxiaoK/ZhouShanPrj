...
{
    class EntranceGuardCtrlAction : CtrlAction
    {
#pragma warning disable CS0612 // 类型或成员已过时
        public EntranceGuardCtrlAction()
        {
        }
#pragma warning restore CS0612 // 类型或成员已过时

        public EntranceGuardCtrlAction(IBaseItem caller) : base(caller)
        {
        }

#pragma warning disable CS0612 // 类型或成员已过时
        public EntranceGuardCtrlAction(IBaseItem caller, IForm formClass) : base(caller: caller, formClass: formClass)
#pragma warning restore CS0612 // 类型或成员已过时
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dockBar != null)
                    {
                        ...
                        (dockBar.Control as VisualMonitorSettingControl).MonitorType = MonitorType.EntranceGuard;
                    }
                }
            }
            catch (Exception ex)
