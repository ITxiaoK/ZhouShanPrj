...
{
    class NewWorkflowCtrlAction : CtrlAction
    {
#pragma warning disable CS0612 // 类型或成员已过时
        public NewWorkflowCtrlAction()
        {
        }
#pragma warning restore CS0612 // 类型或成员已过时

        public NewWorkflowCtrlAction(IBaseItem caller) : base(caller)
        {
        }

#pragma warning disable CS0612 // 类型或成员已过时
        public NewWorkflowCtrlAction(IBaseItem caller, IForm formClass) : base(caller, formClass)
#pragma warning restore CS0612 // 类型或成员已过时
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dockBar != null)
                    {
                        ...
                        (dockBar.Control as WorkflowInfoControl).WorkflowEditType = WorkflowEditType.New;
                    }
                }
            }
            catch (Exception ex)
