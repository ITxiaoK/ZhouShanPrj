...
{
    class UploadDangerResourceFileCtrlAction : CtrlAction
    {
        private Application m_Application;

#pragma warning disable CS0612 // 类型或成员已过时
        public UploadDangerResourceFileCtrlAction()
        {
            try
            {
...
#pragma warning restore CS0612 // 类型或成员已过时
        ...
        public override void Run()
        {
            try
            {
                ...
                {
                    IDockBar dockBar = Application.ActiveApplication.MainForm.DockBarManager[typeof(UploadDangerResourceFileControl)];
                    if (dockBar != null)
                    {
