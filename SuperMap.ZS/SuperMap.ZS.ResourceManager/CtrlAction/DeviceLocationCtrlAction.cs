...
{
    class DeviceLocationCtrlAction : CtrlAction
    {
        private Application m_Application;

#pragma warning disable CS0612 // 类型或成员已过时
        public DeviceLocationCtrlAction()
        {
            try
            {
...
#pragma warning disable CS0612 // 类型或成员已过时
        public DeviceLocationCtrlAction(IBaseItem caller, IForm formClass) : base(caller: caller, formClass: formClass)
#pragma warning restore CS0612 // 类型或成员已过时
        {
        }
