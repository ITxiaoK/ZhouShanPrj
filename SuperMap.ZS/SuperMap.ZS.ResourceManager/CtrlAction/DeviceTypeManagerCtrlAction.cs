...
{
    class DeviceTypeManagerCtrlAction : CtrlAction
    {
        private Application m_Application;

#pragma warning disable CS0612 // 类型或成员已过时
        public DeviceTypeManagerCtrlAction()
        {
            try
            {
...
#pragma warning restore CS0612 // 类型或成员已过时
        ...
        public DeviceTypeManagerCtrlAction(IBaseItem caller) : base(caller)
        {
            try
            {
                m_Application = Application.ActiveApplication;
...
#pragma warning disable CS0612 // 类型或成员已过时
        public DeviceTypeManagerCtrlAction(IBaseItem caller, IForm formClass) : base(caller: caller, formClass: formClass)
#pragma warning restore CS0612 // 类型或成员已过时
        {
        }
        ...
        public override void Run()
        {
            try
            {
                ...
                {
                    IDockBar dockBar = Application.ActiveApplication.MainForm.DockBarManager[typeof(DeviceTypeManagerControl)];
                    if (dockBar != null)
                    {
