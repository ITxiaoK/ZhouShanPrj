...
{
    class VideoCtrlAction : CtrlAction
    {
#pragma warning disable CS0612 // 类型或成员已过时
        public VideoCtrlAction()
        {
        }
#pragma warning restore CS0612 // 类型或成员已过时

        public VideoCtrlAction(IBaseItem caller) : base(caller)
        {
        }

#pragma warning disable CS0612 // 类型或成员已过时
        public VideoCtrlAction(IBaseItem caller, IForm formClass) : base(caller: caller, formClass: formClass)
#pragma warning restore CS0612 // 类型或成员已过时
        {
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dockBar != null)
                    {
                        ...
                        (dockBar.Control as VisualMonitorSettingControl).MonitorType = MonitorType.Video;
                    }
                }
            }
            catch (Exception ex)
