...
{
    class DownloadFilesAction : CtrlAction
    {
...
#pragma warning restore CS0612 // 类型或成员已过时
        ...
        public DownloadFilesAction(IBaseItem caller) : base(caller)
        {
            try
            {
                m_Application = Application.ActiveApplication;
...
#pragma warning disable CS0612 // 类型或成员已过时
        public DownloadFilesAction(IBaseItem caller, IForm formClass) : base(caller: caller, formClass: formClass)
#pragma warning restore CS0612 // 类型或成员已过时
        {
        }
